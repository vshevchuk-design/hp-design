...
<div class="shell">
  ...
  <main>
    ...
    <div class="legend">
      ...
      <div class="row"><b>Step 150</b><span>Added 2026-09-07 — 100→200 was the ramp's harshest jump (the lightness deltas accelerate across the light end: .015, .04, .07), so this splits the biggest one in two. Reach for it when a tint needs to sit between the two, not as a new default.</span></div>
