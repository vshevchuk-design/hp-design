...
const colorPaths = [
  ...
  "surface.sunken", "surface.dim", "surface.dimHover", "border.default", "border.strong", "icon.default",
];
...
.select:hover { background: ${cv("surface.dimHover")}; border-color: ${cv("border.strong")}; }
